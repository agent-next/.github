...
- **[polymarket-paper-trader](https://github.com/agent-next/polymarket-paper-trader)** — Prediction market trading for AI agents. Paper trading with live order books, strategy backtesting, MCP server. Compete on the public leaderboard (submit via repo issues).
